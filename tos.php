<?php include_once('inc/header.php'); ?>
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <p>Nixplorer allows users to upload images and associate them with a unique URL to create online access to the images for themselves and others.</p>
          ...
          <p>Nixplorer is a non-profit website and online service.</p>
          <p>Nixplorer won't allow any ads on our website or service. </p>
          <h4 class="tos4">§5. Security </h4>
          <p>Nixplorer constantly tries to keep up with security on our service.</p>
        </div>
        ...
        <div class="col-md-6">
          ...
          * Copyright 2011-2015 Twitter, Inc. MIT license.
          ...
          <p>This website is available at <a href="https://github.com/OscarHolst/nixplorer-web/" target="_BLANK">github</a> under the MIT License.</p>

          <h4 class="tos4">§9. Disclaimer</h4>
          <p>Nixplorer is not to be held responsible for the images uploaded thru our service.</p>
          <p>Nixplorer have routines to check uploaded material, and will without notice remove copyrighted content and illegal uploads. </p>
        </div>
      </div>
